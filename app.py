...
st.markdown("""
<h5>🙇 내시GPT, 전하를 알현하옵니다 🙇</h5>
<p style='font-size:15px; color:gray;'>
소인은 조선의 궁중에서 사주와 명리를 아뢰던 내시GPT라 하옵니다.<br>
전하께서 태어나신 연월일시를 올려주시면, 감히 팔자를 살펴보아 성정과 기운, 오행의 흐름을 짐작해 아뢰겠사옵니다.<br>
이 모든 해석은 현대의 통계가 아닌 전통 명리 이론에 기반한 재미용이오니, 가볍게 보아주시옵소서.
</p>
